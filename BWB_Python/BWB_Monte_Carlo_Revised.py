...
def analyze_design(spans, root_chords, tip_chords, sweeps, dihedrals,
    ...
    if save_vsp:
        ...
        extensions_to_delete = [
            ".txt", ".avl", ".csv", ".run",
            '_CompGeom.csv', '_CompGeom.txt',
            '_moment.txt', '_np.txt', '_ParasiteBuildUp.csv', '.vsp3'   # FIX: _moment.txt now cleaned up
        ]
...
if __name__ == '__main__':
    ...
    Nominal_Roots = np.array([43.77391902, 31.69045771,  6.45722603,  0.89796151])
    Nominal_Tips = np.array([31.69045771,  6.45722603,  0.89796151,  0.11903162 ])
